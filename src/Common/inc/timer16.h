...
extern volatile uint32_t timer16_0_capture ;
extern volatile uint32_t timer16_1_capture ;
extern volatile uint32_t timer16_0_period ;
extern volatile uint32_t timer16_1_period ;
