/****************************************************************************
 *   $Id: LPC11xx.h 56705 2012-09-05 18:04:42Z anderslu $
...
typedef struct
{
  ...
  __IO uint32_t SSEL1_LOC;							/*!< Offset: 0x018 SSEL1 pin location select register (R/W) */
  ...
  __IO uint32_t CT16B0_CAP0_LOC;        /*!< Offset: 0x0C0 CT16B0_CAP0 pin location select register (R/W) */
  __IO uint32_t SCK1_LOC;        				/*!< Offset: 0x0C4 SCK1 pin location select register (R/W) */
  __IO uint32_t MISO1_LOC;        			/*!< Offset: 0x0C8 MISO1 pin location select register (R/W) */
  __IO uint32_t MOSI1_LOC;        			/*!< Offset: 0x0CC MOSI1 pin location select register (R/W) */
  __IO uint32_t CT32B0_CAP0_LOC;        /*!< Offset: 0x0D0 CT32B0_CAP0 pin location select register (R/W) */
  __IO uint32_t RXD_LOC;        				/*!< Offset: 0x0D4 RXD pin location select register (R/W) */
} LPC_IOCON_TypeDef;
