...
typedef void (*UART0_RCV_HANDLER)(void *buf,unsigned int len);

UART0_RCV_HANDLER    uart0RcvHandler = (void *)0;
...
**
*****************************************************************************/
void UARTSend(void *BufferPtr, uint32_t Length)
{

  unsigned char * buf = BufferPtr;
  while ( Length != 0 )
  {
